...
@section('content')
    ...
    <section class="dbk-info-section">
        <div class="container">
            <div class="dbk-info-intro">
                <h2>Waarom DeBurenKoken?</h2>
                <p>Wij verbinden thuiskoks met buurtbewoners voor eerlijk, vers en lokaal eten.</p>
            </div>

            <div class="dbk-usp-grid">
                <div class="dbk-usp-card">
                    <div class="dbk-usp-icon">🏠</div>
                    <h3>Lokaal & Vers</h3>
                    <p>Gerechten uit jouw buurt, altijd vers bereid door thuiskoks met passie.</p>
                </div>
                <div class="dbk-usp-card">
                    <div class="dbk-usp-icon">💰</div>
                    <h3>Eerlijke Prijzen</h3>
                    <p>Geen dure bezorgkosten. Direct van kok naar jou, voor een eerlijke prijs.</p>
                </div>
                <div class="dbk-usp-card">
                    <div class="dbk-usp-icon">🤝</div>
                    <h3>Gemeenschap</h3>
                    <p>Versterk de band met je buren en ontdek culinaire talenten in je wijk.</p>
                </div>
            </div>

            <div class="dbk-accordion" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="dbk-accordion-item">
                    <div class="dbk-accordion-header" role="tab" id="heading-0">
                        <h3>
                            <span class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-0" aria-expanded="true" aria-controls="collapse-0">
                ...
                <div class="dbk-accordion-item">
                    <div class="dbk-accordion-header" role="tab" id="heading-1">
                        <h3>
                            <span class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
                ...
                <div class="dbk-accordion-item">
                    <div class="dbk-accordion-header" role="tab" id="heading-2">
                        <h3>
                            <span class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-2" aria-expanded="true" aria-controls="collapse-2">
                ...
                <div class="dbk-accordion-item">
                    <div class="dbk-accordion-header" role="tab" id="heading-3">
                        <h3>
                            <span class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-3" aria-expanded="true" aria-controls="collapse-3">
                    ...
                    <div id="collapse-3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-3">
                        <div class="dbk-accordion-body">
                            <p>Wil je meer informatie? klik dan <a href="{{route('register.info')}}">hier</a></p>
                        </div>
                    </div>
                </div>
            </div>
