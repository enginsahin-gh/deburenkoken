                ...
                <tr>
                    <td align="center" valign="top">
                        <table width="350" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left-inner">
                            ...
                            <tr>
                                <td align="left" valign="top">
                                   Hier is het dagelijkse rapport van DeBurenKoken.nl:
                                </td>
                            </tr>
                            <tr>
                                <td height="20" align="center" valign="top" style="font-size:10px; line-height:10px;">&nbsp;</td>
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <strong>Aantal nieuwe accounts vandaag:</strong> {{ $data['countNewUsers'] }}<br>
                                    <strong>Aantal accounts met gewijzigd e-mailadres vandaag:</strong> {{ $data['countUpdatedEmailUsers'] }}<br>
                                    <strong>Aantal verwijderde accounts vandaag:</strong> {{ $data['countDeletedUsers'] }}<br>
                                    <strong>Aantal orders vandaag:</strong> {{ $data['countOrdersToday'] }}<br>
                                    <strong>Aantal advertenties vandaag:</strong> {{ $data['countAdvertsToday'] }}<br>
                                    <strong>Aantal geannuleerde advertenties vandaag:</strong> {{ $data['countCancelledAdvertsToday'] }}<br>
                                    <strong>Aantal actieve orders vandaag:</strong> {{ $data['countActiveOrders'] }}<br>
                                    <strong>Aantal geannuleerde orders vandaag:</strong> {{ $data['countCancelledOrders'] }}<br>
                                    <strong>Aantal gefaalde orders vandaag:</strong> {{ $data['countFailedOrders'] }}<br>
                                </td>
                            </tr>
                            <tr>
                                <td height="20" align="center" valign="top" style="font-size:10px; line-height:10px;">&nbsp;</td>
