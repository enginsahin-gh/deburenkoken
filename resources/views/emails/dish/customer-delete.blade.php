                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                <table width="350" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left-inner">
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            Helaas moeten wij je mededelen dat onderstaande bestelling is geannuleerd.<br>
                                                            Je geld zal teruggestort worden op je rekening. De Thuiskok heeft een boodschap achtergelaten.
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:12px; color:#000000; line-height:25px; font-weight:normal;">
                                                            <li style="list-style-type: disc;">{{$order->getParsedOrderUuid()}}</li>
