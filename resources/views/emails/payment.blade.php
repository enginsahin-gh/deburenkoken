...
<head>
    ...
    <title>Uitbetaling {{ env('APP_NAME') }}</title>
            ...
            <td align="center" valign="top">
                ...
                <div class="content-wrapper">
                    <div class="order-section">
                        ...
                        <div class="message">
                            Je uitbetalingsaanvraag is succesvol verwerkt door DeBurenKoken. Het bedrag van {{ $amount }} euro zal binnen 3 werkdagen op je bankrekening staan.
                        </div>
