...
<head>
    ...
    <style type="text/css">
        ...
        /* Extra ruimte boven elke sectietitel */
        .section-title {
            color: #ff6b00 !important;
            font-weight: 600;
            font-size: 16px;
            margin-top: 20px;  /* Extra witregel boven de titel */
            margin-bottom: 15px;
                ...
                <div class="content-wrapper">
                    <div class="order-section">
                        ...
                        <!-- Hallo {{$order->client->getName()}}, -->
                            Hallo {{$order->user->getUsername()}},
                            <br><br>
                            De onderstaande bestelling is geannuleerd door {{$order->client->getName()}}.
                        </div>
                        ...
                        <div class="order-info">
                            ...
                            <div class="info-row">
                                ...
                                <div class="value">{{ \Carbon\Carbon::parse($order->advert->getPickupDate())->locale('nl')->translatedFormat('l j F') }}, {{ substr($order->advert->getPickupFrom(), 0, 5) }} - {{ substr($order->advert->getPickupTo(), 0, 5) }}</div>
                            </div>
                            <div class="info-row">
                        ...
                        <div class="order-info">
                            <div class="info-row">
                                ...
                                <div class="value">{{$order->client->getName()}}</div>
                            </div>
                            <div class="info-row">
                                <div class="label">E-mail:</div>
                                <div class="value">{{$order->client->getEmail()}}</div>
                            </div>
                            <div class="info-row">
                                <div class="label">Telefoon:</div>
                                <div class="value">{{$order->client->getPhoneNumber()}}</div>
                            </div>
                        </div>
