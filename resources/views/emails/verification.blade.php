...
<head>
    ...
    <title>E-mailverificatie {{env('APP_NAME')}}</title>
                        ...
                        <tr>
                            <td style="padding: 0 20px;">
                                <div class="greeting">
                                    ...
                                    <br><br>
                                    Je aanvraag voor een account is succesvol ontvangen.
                                    Rond je aanvraag af door je e-mailadres te verifiëren en ga direct aan de slag.
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="button-container" align="center" style="padding: 30px 20px;">
                                <!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{$link}}" style="height:52px;v-text-anchor:middle;width:260px;" arcsize="15%" strokecolor="#f3723b" strokeweight="0pt" fillcolor="#f3723b">
                                  <w:anchorlock/>
