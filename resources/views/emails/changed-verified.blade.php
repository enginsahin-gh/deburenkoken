...
<head>
    ...
    <style type="text/css">
        ...
        .greeting, .signature, .content-container {
                    ...
                    <div class="order-section">
                        ...
                        <div class="content-container">
                            <div class="greeting">
                                Hallo {{$username}},
                                <br><br>
                                Je e-mailadres is succesvol gewijzigd. Veel kookplezier!
                                <br><br>
                                Wil je de veelgestelde vragen voor Thuiskoks zien? Druk dan op de link hieronder.
                            </div>

                            <!-- Button in een tabel voor betere compatibiliteit met Outlook -->
                            <div class="button-container">
                                <!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{route('cook.facts')}}" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="12%" strokecolor="#f3723b" strokeweight="0pt" fillcolor="#f3723b">
                                  <w:anchorlock/>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" align="center">
                                    <tr>
                                        <td align="center" bgcolor="#f3723b" 
                                            ...
                                            <a href="{{route('cook.facts')}}" target="_blank" 
