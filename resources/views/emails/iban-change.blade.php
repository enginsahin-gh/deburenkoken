...
<head>
    ...
    <title>IBAN gewijzigd {{env('APP_NAME')}}</title>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="background-color: #f5f7fa;" align="center">
                <div style="border-radius: 8px; mso-border-radius-alt: 8px; background: #ffffff; padding: 30px; max-width: 400px; margin: 0 auto;">
    <![endif]-->
                ...
                <div class="content-wrapper">
                    <div class="header-section">
                        <a href="{{env('APP_URL')}}">
                            ...
                            <![endif]-->
                            <!--[if !mso]><!-->
                            <img src="{{asset('img/logo.png')}}" class="logo" width="480" alt="{{env('APP_NAME')}}" style="max-width: 200px; height: auto; margin: 20px auto; display: block; border: 0; outline: none;" />
                            <!--<![endif]-->
                        </a>
                        ...
                        <div class="message-content">
                            ...
                            <p>Je IBAN is succesvol gewijzigd.</p>
                        </div>
